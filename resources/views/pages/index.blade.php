...
<div class="container-fluid p-0">
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>{{ __('admincp.page') }}</strong>  <a href="{{route('pages.create')}}" class="btn btn-sm btn-primary">{{__('admincp.add')}}</a> </h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <table class="table table-bordered"  id="data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $posts->title }}</td>
                                <td>{{ $posts->lang}}</td>
                                <td><a href="/{{$posts->lang}}/{{$posts->slug}}">{{$posts->slug}}</a></td>
                                <td>{{ $posts->status }}</td>
                                <td>
