...
<div class="container-xxl py-5">
    ...
    <div class="container">
        ...
        <div class="table-responsive mb-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@foreach ($laporan->docs as $doc)
                        @if ($loop->first)
                            <a href="/storage/{{ $doc->path }}" target="_blank" class="btn btn-sm btn-primary"><i class="fas fa-file-download"></i> Download </a>
                        @endif
                    @endforeach
                    </td>
                </tr>
        ...
        <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
          <div class="border-start border-5 border-primary ps-4 mb-5">
            <!-- <h6 class="text-body text-uppercase mb-2"></h6> -->
        ...
        <div class="table-responsive mb-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>@foreach ($laporans->docs as $docs)
                        @if ($loop->first)
                            <a href="/storage/{{ $docs->path }}" target="_blank" class="btn btn-sm btn-primary"><i class="fas fa-file-download"></i> Download </a>
                        @endif
                    @endforeach
                    </td>
                </tr>
        ...
        <div class="mt-5"><div class="ir_textDivider reset"></div>
        <p class="ir_textFootnote si_fixed">
            ...
            <strong>Note:</strong> Files are in Adobe (PDF) format.<br>Please download the free <a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank">Adobe Acrobat Reader</a> to view these documents.</p>    </div>
    </div>
</div>
@endsection
