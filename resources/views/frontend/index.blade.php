                ...
                <div class="d-flex flex-sm-row flex-column justify-content-lg-between">
                    <div class="team-item position-relative p-2">
                        ...
                        <div class="team-text bg-white p-4">
                            <h6><a href="/media/pt-sumber-mineral-global-abadi" class="text-dark">PT Sumber Mineral Global
                                    Abadi</a></h6>
                    ...
                    <div class="team-item position-relative p-2">
                        <img class="img-fluid" src="/img/3.jpeg" alt="" />
                        <div class="team-text bg-white p-4">
                            <h6><a href="/media/pt-mandau-batu-alam" class="text-dark">PT Mandau Batu Alam</a></h6>
                    ...
                    <div class="team-item position-relative p-2">
                        <img class="img-fluid" src="/img/3.jpeg" alt="" />
                        <div class="team-text bg-white p-4">
                            <h6><a href="/media/pt-angkasa-nusa-graha" class="text-dark">PT Angkasa Nusa Graha</a></h6>
                    ...
                    <div class="team-item position-relative p-2">
                        <img class="img-fluid" src="/img/3.jpeg" alt="" />
                        <div class="team-text bg-white p-4">
                            <h6><a href="/media/pt-transmarina-pelabuhan-indonesia" class="text-dark">PT Transmarina
                                    Pelabuhan
                                    Indonesia</a></h6>
                    ...
                    <div class="team-item position-relative p-2">
                        <img class="img-fluid" src="/img/3.jpeg" alt="" />
                        <div class="team-text bg-white p-4">
                            <h6><a href="/media/hineni-resources-pte-ltd" class="text-dark">Hineni Resources Pte, Ltd</a>
                            </h6>
