                ...
                <div class="d-flex flex-sm-row flex-column justify-content-lg-between">
                    <div class="team-item position-relative p-2">
                        ...
                        <div class="team-text bg-white p-4">
                            <h6><a href="/en/pt-sumber-mineral-global-abadi" class="text-dark">PT Sumber Mineral Global
                                    Abadi</a></h6>
                    ...
                    <div class="team-item position-relative p-2">
                        <img class="img-fluid" src="/img/3.jpeg" alt="" />
                        <div class="team-text bg-white p-4">
                            <h6><a href="/en/pt-transmarina-pelabuhan-indonesia" class="text-dark">PT Transmarina Pelabuhan
                                    Indonesia</a></h6>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item bg-light overflow-hidden h-100">
                            ...
                            <div class="service-text position-relative text-center h-100 p-4">
                                ...
                                <a class="small" href="/{{ $post->lang }}/{{ $post->slug }}">READ MORE<i
                                        class="fa fa-arrow-right ms-3"></i></a>
                            </div>
                        </div>
                    </div>
