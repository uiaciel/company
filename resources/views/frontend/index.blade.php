      ...
      <div class="row g-5">
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="h-100">
            ...
            <p>
                Sumber Globar Energy Tbk (SGE) has strengthened its position as the most reliable coal trading company in the export and domestic coal market by its systematic one stop coal supplier system from coal miners to delivery. We can sell to export customers on FOB/CFR/CIF vessel basis.
                We  started this business in Jakarta in 2008, trading coal from South and East Kalimantan to domestic and export clients. We are currently hard at work supplying coal, nickel and other commodities to export and domestic customers.              </p>
            <p class="mb-4">
                We export to China, India, Vietnam, Bangladesh, South Korea and Asian/European markets
                With all the hard-work and dedication, SGER has become the top 5 National coal trading company in Indonesia with excellent reputation, especially the ON-time delivery and good performance. In 2021 SGER sold more than 3 million MT of coal, and is aiming to sell 6 million MT in 2022.
            </p>
            <p class="mb-4">Now SGE has 8 subsidiaries, with various lines of businesses, ranging from coal mining company to waste-to-energy project. We also have offices in Singapore and Kalimantan.
                To spur its rapid growth, In 2020 SGE went public and listed in Indonesia Stock Exchange, (Ticker : SGER and ISIN Code :  ID1000156706)
            </p>
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <ol class="list-group list-group-numbered">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-start">
                ...
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#ann{{$announ->id}}">
                    View
                </button>
              </li>
                            <!-- Button trigger modal -->
                <!-- Modal -->
                <div class="modal fade" id="ann{{$announ->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content text-center">
                        ...
                        <div class="modal-body">
                            @foreach ($announ->images as $image)
                            @if ($loop->first)
            ...
            <div class="service-text position-relative text-center h-100 p-4">
              ...
              @foreach ($laporan->docs as $doc)
                        @if ($loop->first)
                            ...
                            <a class="small" href="/storage/{{ $doc->path }}" target="_blank"
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="service-item bg-light overflow-hidden h-100">
            ...
            <div class="service-text position-relative text-center h-100 p-4">
              ...
              <a class="small" href="/{{$post->lang}}/{{$post->slug}}"
                >READ MORE<i class="fa fa-arrow-right ms-3"></i
              ></a>
            </div>
          </div>
...
<div
        ...
        <div class="col-lg-9 col-md-6 wow fadeIn" data-wow-delay="0.3s">
          <div class="border-start border-5 border-primary ps-4 mb-5">
            ...
            <h1 class="display-6 text-white mb-0">
              Large Trade in Solid, Liquid, Gas, Renewable Energy and Rare Earth Metals and Minerals Mining in Subsidiaries
            </h1>
          </div>
  ...
  <!-- Modal -->
      @if (empty($modal->id))
   @else
   <div class="modal fade" id="modal{{$modal->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">{{__('home.announcement')}} <small>{{$modal->date_gmt}}</small></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        <div class="modal-body">
            @foreach ($modal->images as $image)
                ...
                @endif
            @endforeach
          {{-- <img src="/images/ringkasan-risalah-rups.png" class="img-fluid" width="500px;" /> --}}
          <p class="text-center">
            @foreach ($modal->docs as $doc)
            @if ($loop->first)
